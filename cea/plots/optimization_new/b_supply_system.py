...
class SupplySystemGraphInfo(object):
    ...
    def _get_data(self, energy_system_id, supply_system_id):
        ...
        supply_system_file = \
            SupplySystemGraphInfo._locator.get_centralized_optimization_optimal_supply_system_file(district_energy_system_id=energy_system_id,
...
def main():
    ...
    for district_energy_system in des_solution_folders:
        supply_systems = locator.get_centralized_optimization_optimal_supply_system_ids(district_energy_system_id=district_energy_system)
