...
class Domain(object):
    ...
    def _write_network_layouts_to_geojson(self, district_energy_system, system_name=None):
        ...
        for ntw_ind, network in enumerate(district_energy_system.networks):
            network_layout_file = (
                self.locator.get_centralized_optimization_optimal_network_layout_file(district_energy_system_id=system_name,
    ...
    def _write_supply_systems_to_csv(self, district_energy_system, system_name=None):
        ...
        for building in stand_alone_buildings:
            ...
            building_file = self.locator.get_centralized_optimization_optimal_supply_system_file(district_energy_system_id=system_name,
                                                                                                 supply_system_id=supply_system_id)
        ...
        for network_id, supply_system in district_energy_system.supply_systems.items():
            # Summarise structure of the supply system & print to file
            network_file = self.locator.get_centralized_optimization_optimal_supply_system_file(district_energy_system_id=system_name,
                                                                                                supply_system_id=network_id)
        ...
        summary_file = self.locator.get_centralized_optimization_optimal_supply_systems_summary_file(district_energy_system_id=system_name)
    ...
    def _write_detailed_results_to_csv(self, district_energy_system):
        ...
        for building in stand_alone_buildings:
            ...
            building_file = self.locator.get_centralized_optimization_supply_systems_detailed_operation_file(district_energy_system_id=des_id,
                                                                                                             supply_system_id=supply_system_id)
        ...
        for network_id, supply_system in district_energy_system.supply_systems.items():
            # Summarise the objective function profiles (i.e. full time series) of the supply system & print to file
            network_file = self.locator.get_centralized_optimization_supply_systems_detailed_operation_file(district_energy_system_id=des_id,
                                                                                                            supply_system_id=network_id)
            ...
            breakdown_file = self.locator.get_centralized_optimization_supply_systems_annual_breakdown_file(district_energy_system_id=des_id,
                                                                                                            supply_system_id=network_id)
        ...
        if district_energy_system.networks:
            network_perf_file = self.locator.get_centralized_optimization_detailed_network_performance_file(district_energy_system_id=des_id)
